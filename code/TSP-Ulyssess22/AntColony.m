...
map(1,1:2)=[38.24,20.42];
map(2,1:2)=[39.57,26.15];
map(3,1:2)=[40.56,25.32];
map(4,1:2)=[36.26,23.12];
map(5,1:2)=[33.48,10.54];
map(6,1:2)=[37.56,12.19];
map(7,1:2)=[38.42,13.11];
map(8,1:2)=[37.52,20.44];
map(9,1:2)=[41.23,9.10];
map(10,1:2)=[41.17,13.05];
map(11,1:2)=[36.08,-5.21];
map(12,1:2)=[38.47,15.13];
map(13,1:2)=[38.15,15.35];
map(14,1:2)=[37.51,15.17];
map(15,1:2)=[35.49,14.32];
map(16,1:2)=[39.36,19.56];
map(17,1:2)=[38.09,24.36];
map(18,1:2)=[36.09,23.00];
map(19,1:2)=[40.44,13.57];
map(20,1:2)=[40.33,14.15];
map(21,1:2)=[40.37,14.23];
map(22,1:2)=[37.57,22.56];
